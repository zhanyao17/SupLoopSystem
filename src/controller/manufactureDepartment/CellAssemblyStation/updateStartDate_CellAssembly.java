...
//Program Name: updateStartDate_CellAssembly.java
...
public class updateStartDate_CellAssembly implements Initializable
{
    // Label
    ...
    public void Cancel()
    {
        jobCardPreview_CellAssembly.inUpdateStatusMode = false;
