...
//Program Name: updateStartDate_JerryRoll.java
...
public class updateStartDate_JerryRoll implements Initializable{
    ...
    public void Cancel()
    {
        JobCardPreview_JerryRoll.inUpdateStatusMode = false;
