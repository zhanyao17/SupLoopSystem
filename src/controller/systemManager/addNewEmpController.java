...
public class addNewEmpController implements Initializable
{
    ...
    @FXML private Button saveRecord;
    ...
    //define statement
    private String employeeListQuery =  "SELECT e.Emp_ID, e.Emp_name,e.Emp_contact, e.Dept_ID, d.Dept_name " +
                                        "from employees e " +
    ...
    public void showEmployeeId(String ed) throws SQLException
    {
        empId = ed;
    ...
    public void warningInformation() 
    {
        ...
        alert.setContentText("New Employee Details Informations !!\n"+
                            "Employee details had been sucessfully saved.");
